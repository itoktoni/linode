<div @class([
        ' inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-5 sm:pt-4',
        $positionClasses,
        $zIndex,
    ])
     ...
     wire:ignore>
    <div class="flex fixed top-0 right-0 z-50 flex-col-reverse w-full max-w-sm gap-y-2 pointer-events-auto">
