<x-app-layout title="Menu List Component" is-sidebar-open="true" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-4">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-3.5 font-inter font-medium">
                            <li>
                                <a class="inline-flex items-center font-medium tracking-wide text-primary outline-hidden dark:text-accent-light"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                            <li>
                                <a class="inline-flex items-center tracking-wide outline-hidden transition-colors hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                    href="#">
                                    <span>Shipping</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-primary px-4 py-2.5 tracking-wide text-white outline-hidden transition-all dark:bg-accent"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex rounded-lg px-4 py-2.5 tracking-wide outline-hidden transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
                                    href="#">
                                    <span>Shipping</span>
                                </a>
                            </li>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-full bg-primary px-5 py-2.5 tracking-wide text-white outline-hidden transition-all dark:bg-accent"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex rounded-full px-5 py-2.5 tracking-wide outline-hidden transition-all hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary dark:hover:bg-accent-light/15 dark:hover:text-accent-light dark:focus:bg-accent-light/15 dark:focus:text-accent-light"
                                    href="#">
                                    <span>Shipping</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex items-center space-x-2 rounded-full bg-primary px-5 py-2.5 tracking-wide text-white outline-hidden transition-all dark:bg-accent"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            ...
                            <li>
                                <a class="group flex space-x-2 rounded-full px-5 py-2.5 tracking-wide outline-hidden transition-all hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary dark:hover:bg-accent-light/15 dark:hover:text-accent-light dark:focus:bg-accent-light/15 dark:focus:text-accent-light"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-slate-150 px-4 py-2.5 tracking-wide text-slate-800 outline-hidden transition-all dark:bg-navy-500 dark:text-navy-50"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-slate-150 bg-linear-to-r from-purple-500 to-purple-600 px-4 py-2.5 tracking-wide text-white outline-hidden transition-all"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg border border-slate-150 px-4 py-2.5 tracking-wide text-primary shadow-xs outline-hidden transition-all dark:border-navy-500 dark:text-accent-light"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
