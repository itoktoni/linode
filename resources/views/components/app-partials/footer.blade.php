<nav class="footer bg-white print:hidden fixed bottom-0 z-10 w-full h-12">
    <!-- App Header  -->
    <div class="header-container p-2 flex w-full border-t-2 bg-dark dark:bg-navy-750 print:hidden">
        <!-- Header Items -->
